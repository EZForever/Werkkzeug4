...
sInt sGetBitsPerPixel(sInt format)
{
  ...
  switch(format&sTEX_FORMAT)
  {
    ...
    case sTEX_ABGR8888: BitsPerPixel = 32;  break;
...
sTexture2D::sTexture2D(sInt xs,sInt ys,sU32 flags,sInt mipmaps,void *shareHandle)
{
  Flags = sTEX_2D;
  Init(xs,ys,flags|sTEX_2D,mipmaps,0,shareHandle);
}
...
void sTexture2D::Init(sInt xs, sInt ys, sInt flags,sInt mipmaps, sBool force, void *shareHandle/*=sFALSE*/)
{
  sInt realmip;
  sVERIFY(LoadBuffer==0);
